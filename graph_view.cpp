...
//    backgroundBrush().setTextureImage(QImage("D:/use.png"));
//    this->setBackgroundBrush(backgroundBrush());
    this->setBackgroundBrush(Qt::transparent);
    myGraphicsScene = new QGraphicsScene();
    /*
    QPixmap bgImage = QPixmap("D:/use.png");
    QGraphicsPixmapItem* bgItem = new QGraphicsPixmapItem(bgImage);
    myGraphicsScene->addItem(bgItem);
    */
